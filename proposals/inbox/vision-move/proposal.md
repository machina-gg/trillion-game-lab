...
リモートワーカーの 61% が筋骨格系の痛みを経験し、うち 72% のオフィスワーカーが首・腰・肩・肘・手首のいずれかに不調を抱えている（出典: [PMC研究](https://pmc.ncbi.nlm.nih.gov/articles/PMC9800234/)、2026-03-15 取得）。
...
| 観点 | 既存プロダクト（PostureMinder / RiseLoop / eyeCare） | vision-move |
|------|-------------|-------------|
| 機能統合 | 姿勢・目・休憩がバラバラのツール | 3機能を1つの拡張に統合 |
| パーソナライズ | 固定タイマーのみ | 作業負荷・時間帯・疲労度に応じてリマインド間隔を自動調整 |
| ガイド品質 | テキスト通知のみ | ビジュアルストレッチガイド付き（アニメーション） |
| Vision シリーズ連携 | なし | vision-focus と連携し、集中セッション後に自動的に健康ブレークを提案 |
| プライバシー | クラウド送信が多い | ローカル処理のみ、データ外部送信なし |
| 信頼性 | タイマーズレや通知漏れの報告あり | 確実な通知と Manifest V3 対応 |
...
| 指標 | 値 | ソース | 取得日 |
|------|-----|--------|--------|
| TAM（法人ウェルネスソフト） | $811.91M（2024年） → $1.48B（2030年） | [Fortune Business Insights](https://www.fortunebusinessinsights.com/corporate-wellness-market-106931) | 2026-03-15 |
...
| 法人ウェルネスソフト CAGR | 10.58%（2024〜2030） | [Fortune Business Insights](https://www.fortunebusinessinsights.com/corporate-wellness-market-106931) | 2026-03-15 |
...
- [Fortune Business Insights — Corporate Wellness Market](https://www.fortunebusinessinsights.com/corporate-wellness-market-106931) — 信頼度: ★★★ — 取得日: 2026-03-15
...
- [PostureMinder — Chrome Stats](https://chrome-stats.com/d/dkmkfopiihabelocpelofchappjjnpkm) — 信頼度: ★★★ — 取得日: 2026-03-15
