...
| 価格（月額） | $29〜 | $29〜（月払い）/ $21〜（年払い） | $14〜（年払い）/ $19〜（月払い） | $19〜（想定） |
...
- Lately.ai は月払い $19〜だが Growth プランは $239/月と高額で、フル機能にはコスト負担が大きい
...
> **転換率 5% の根拠**: First Page Sage「SaaS Freemium Conversion Rates: 2026 Report」（80+ SaaS 企業、2021-2025 年データ）によると、フリーミアム SaaS の有料転換率は業界平均 3.7%（従来型フリーミアム）〜 5.8%（RegTech 最高値）。コンテンツツール領域の類似カテゴリを参考に 5% と設定。（出典: [First Page Sage, 2026](https://firstpagesage.com/seo-blog/saas-freemium-conversion-rates/) 取得日: 2026-03-15）
...
| SAM（AI コンテンツリパーパシングツール市場） | $2.14B（2024）→ $2.75B（2025） | [Intel Market Research](https://www.intelmarketresearch.com/ai-content-creationoptimization-software-market-37066)（信頼度★★）+ [DataMint Intelligence](https://www.datamintelligence.com/research-report/ai-powered-content-creation-tools-market)（信頼度★★、2025 年 $2.75B 推計と概ね一致） + [Roots Analysis](https://www.rootsanalysis.com/ai-powered-content-creation-market)（信頼度★★、2025 年 $2.75B と一致） | 2026-03-15 |
| SOM（ソロクリエイター・中小企業向け Micro SaaS） | $138M（SAM の 5% 推定） | SAM $2.75B × 5%。根拠: ① ソロクリエイター・フリーランサーは SAM 全体の約 30% を占めると推定（クリエイターエコノミー 200M 人中、ツール有償利用層は推計 15〜20M 人）。② そのうち月額 $50 以下の低価格帯 Micro SaaS が占めるシェアは類似 SaaS（Repurpose.io 等）の価格帯分布から約 15〜20% と推定。③ 保守的に 5% とした。 | 2026-03-15 |
...
- [DataMint Intelligence: AI-Powered Content Creation Tools Market](https://www.datamintelligence.com/research-report/ai-powered-content-creation-tools-market) — 信頼度: ★★ — 取得日: 2026-03-15（SAM 裏付けソース。2024 年 $2.14B、CAGR 17.58% と Intel Market Research と概ね一致）
- [Roots Analysis: AI-Powered Content Creation Market](https://www.rootsanalysis.com/ai-powered-content-creation-market) — 信頼度: ★★ — 取得日: 2026-03-15（SAM 裏付けソース。2025 年 $2.75B と 3 社データが収束）
- [First Page Sage: SaaS Freemium Conversion Rates: 2026 Report](https://firstpagesage.com/seo-blog/saas-freemium-conversion-rates/) — 信頼度: ★★★ — 取得日: 2026-03-15（転換率 5% 根拠。80+ SaaS 企業のフリーミアム転換率ベンチマーク）
...
- [Castmagic 料金ページ](https://www.castmagic.io/pricing) — 信頼度: ★★★ — 取得日: 2026-03-15（Hobby $29/月（月払い）/ $21/月（年払い）、Starter $99/月（月払い）/ $79/月（年払い）、Business $999/月（月払い）/ $790/月（年払い））
- [Lately.ai 料金ページ](https://www.lately.ai/pricing) — 信頼度: ★★★ — 取得日: 2026-03-15（Starter $14/月〜（年払い）/$19/月〜（月払い）、Growth $199/月（年払い）/$239/月（月払い）、Enterprise 要問い合わせ）
